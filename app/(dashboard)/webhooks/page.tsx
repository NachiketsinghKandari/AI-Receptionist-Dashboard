...
export default function WebhooksPage() {
  ...
  const filters = useMemo(
    ...
    [platform, multipleTransfers, effectiveDateRange.startDate, effectiveDateRange.endDate, debouncedSearch, limit, offset, sortBy, sortOrder]
  );
  ...
  const { data: dateOnlyData } = useWebhooks(dateOnlyFilters);
